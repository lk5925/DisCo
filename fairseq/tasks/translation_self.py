...
class TranslationSelfTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--mask-range', action='store_true',
                            help='dynamic length')
        parser.add_argument('--full-masking', action='store_true', default=False,
                            help='full masking')
        parser.add_argument('--dynamic-masking', action='store_true', default=False,
                            help='Dynamic masking. Mask in the model.')
        parser.add_argument('--skip-eos', action='store_true', default=False,
                            help='Do not mask eos')
